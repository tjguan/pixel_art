...
# set autoreset to True for the terminal to return to normal colors
init(autoreset=True)

# create "pixels" objects with eight colors
BLACK = Back.BLACK + '  '
RED = Back.RED + '  '
GREEN = Back.GREEN + '  '
YELLOW = Back.YELLOW + '  '
...
# use a dictionary color as key and Colorama object as value
COLORS_DICT = {
  'black' : BLACK,
  'red' : RED,
  'green' : GREEN,
...
class Image():
  ...
  #helper method to add pix\els to the Image
